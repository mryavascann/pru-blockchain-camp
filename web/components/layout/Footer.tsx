      ...
      <Container className="py-10">
        <div className="flex flex-col gap-8 md:flex-row md:justify-between">
          ...
          <nav className="flex flex-col gap-2 text-sm" aria-label="Alt menü">
            <Link href="/kamplar" className="text-[var(--fg-secondary)] hover:text-[var(--fg-primary)]">
              {t.nav.camps}
            </Link>
            <Link href="/siralama" className="text-[var(--fg-secondary)] hover:text-[var(--fg-primary)]">
              {t.nav.leaderboard}
            </Link>
            <Link href="/katil" className="text-[var(--fg-secondary)] hover:text-[var(--fg-primary)]">
              {t.nav.join}
            </Link>
          </nav>
        </div>
        ...
        */}
        <div className="mt-8 flex flex-col gap-2 border-t border-[var(--border-subtle)] pt-6 text-xs text-[var(--fg-muted)] md:flex-row md:items-center md:justify-between">
          <span>
            ...
            <a
              ...
              className="mono underline underline-offset-2 hover:text-[var(--fg-secondary)]"
            >
              {contractAddress}
            </a>
          </span>
